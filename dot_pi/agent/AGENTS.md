...
- **Don't decide the depth for the user — ask.** Before sinking effort into investigation or shipping a quick fix, check what level of rigor the user wants for this task. Don't autonomously expand or minimize scope.
